...
<div id="sidebar">
    ...
    <div id="sidebar-brand" class="themed-background">
        <a href="index.php" class="sidebar-title">
            <i class="fa fa-btc"></i> <span class="sidebar-nav-mini-hide"><!-- BITPRO --><strong><?=$_SESSION['USER']?></strong></span>
        </a>
    </div>
    <!-- END Sidebar Brand -->
    ...
    <div id="sidebar-extra-info" class="sidebar-content sidebar-nav-mini-hide">
        ...
        <div class="text-center">
            <small>Crafted with <i class="fa fa-heart text-danger"></i> by <a href="http://goo.gl/vNS3I" target="_blank">shahrul8k</a></small><br>
